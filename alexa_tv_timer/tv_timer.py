...
class device_handler(debounce_handler):
    ...
    """
    TRIGGERS = {"sleep timer": 52002}

    def act(self, client_address, state):
        print "State", state, "from client @", client_address
        subprocess.Popen("bash /home/pi/projects/tv_timer.sh &", shell=True)
        #    subprocess.Popen("irsend SEND_ONCE vizio KEY_POWER", shell=True)
	    #subprocess.Popen("irsend SEND_ONCE Apple_A1294 KEY_PLAY", shell=True)
        return True
